...
CREATE TABLE `t_finance_analysis` (
                            ...
                            `total_add_percent` decimal(20,4) DEFAULT NULL COMMENT '总营收同比增长',
                            `net_profit` decimal(40,5) DEFAULT NULL COMMENT '扣非利润',
                            `net_profit_percent` decimal(20,4) DEFAULT NULL COMMENT '扣非同比增长',
                            `profit_total_percent` decimal(20,4) DEFAULT NULL COMMENT '扣非营收百分比',
