    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="nav-click " ><a href="${request.contextPath}/companyStock"><i class="fa fa-circle-o text-yellow"></i><span>${"北向资金分析"}</span></a></li>
                <li class="nav-click " ><a href="${request.contextPath}/companyStock"><i class="fa fa-circle-o text-yellow"></i><span>${"公司价值分析"}</span></a></li>
...
<#-- common -->
    <script src="${request.contextPath}/js/common.1.js"></script>
    <script>
